...
'sqlite3', # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': '/home/sasasas/webwork/EoSGP201011/data.db',                      # Or path to database file if using sqlite3.
